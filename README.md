...
* Botón [🔗](#bot%C3%B3n)
* Modulo micrófono [🔗](#sensor-de-ruido--micr%C3%B3fono)
* Carcasa
* Cables duPont
* Protoboard
...
* configurar las conexiones en *LED Preferences*. [🔗](#led-preferences---botones)
* configurar las funciones de interacción en *Time & Macros*. [🔗](#time--macros---botones)
